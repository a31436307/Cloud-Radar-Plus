...
const classNameMap = {
  'Attach': {
    'Weapon': {
      'Lower': {
        'AngledForeGrip':     ['三角握把', 0b10000000000000000000000000000000],
        'Foregrip':           ['垂直握把', 0b10000000000000000000000000000000]
      },
      'Magazine': {
        'Extended': {
          //'Medium': '冲长',
          'Large':            ['步枪扩容', 0b01000000000000000000000000000000],
          'SniperRifle':      ['狙击枪扩容', 0b00000100000000000000000000000000]
        },
        'ExtendedQuickDraw': {
          //'Medium': '冲长快',
          'Large':            ['步枪快速扩容', 0b01000000000000000000000000000000],
          'SniperRifle':      ['狙击枪快速扩容', 0b00000100000000000000000000000000]
        }
      },
      'Muzzle': {
        'Compensator': {
          'Large':            ['步枪补偿器', 0b00100000000000000000000000000000]
        },
        'FlashHider': {
          'Large':            ['步枪消焰', 0b00100000000000000000000000000000],
          'SniperRifle':      ['狙击枪消焰', 0b00000010000000000000000000000000]
        },
        'Suppressor': {
          //'Medium': '冲消',
          'Large':            ['步枪消音器', 0b00010000000000000000000000000000],
          'SniperRifle':      ['狙击枪消音器', 0b00000001000000000000000000000000]
        },
      },
      'Stock': {
        ...
        'SniperRifle': {
          ...
          'CheekPad':         ['托腮板', 0b00000000100000000000000000000000]
        }
      },
      'Upper': {
        'DotSight':           ['红点', 0b00000000010000000000000000000000],
        'Holosight':          ['全息', 0b00000000010000000000000000000000],
        'Aimpoint':           ['二倍镜', 0b00000000010000000000000000000000],
        'ACOG':               ['四倍镜', 0b00000000001000000000000000000000],
        'CQBSS':              ['八倍镜', 0b00000000001000000000000000000000]
      }
    }
  },
  'Weapon': {
    'Grenade':                ['手雷',       0b00000000000100000000000000000000],
    'SmokeBomb':              ['烟雾弹',       0b00000000000010000000000000000000],
    ...
    'Pan':                    ['平底锅',       0b00000000000000000000100000000000],
    //'DP28': '盘',
    //'UMP': 'ump',
    //'Vector': 'vct',
    //'uzi': 'uzi'
  ...
  'Armor': {
    'C': { '01': { 'Lv3':     ['三级防弹衣',     0b00000000000000000000000010000000]} },
    'D': { '01': { 'Lv2':     ['二级防弹衣',     0b00000000000000000000000100000000]} },
  },
  'Boost': {
    'EnergyDrink':            ['能量饮料',     0b00000000000000000000000001000000],
    'PainKiller':             ['止疼药',     0b00000000000000000000000001000000]
  },
  'Heal': {
    'FirstAid':               ['急救包',     0b00000000000000000000000000100000],
    'MedKit':                 ['医疗箱',     0b00000000000000000000000000010000],
    //'Bandage':                ['绷带',     0b00000000000000000000000000000000]
  },
  'Back': {
    'C': {
      '01': { 'Lv3':          ['三级包',     0b00000000000000000000000000001000] },
      '02': { 'Lv3':          ['三级包',     0b00000000000000000000000000001000] }
    },
    'F': {
      '01': { 'Lv2':          ['二级包',     0b00000000000000000000000000001000] },
      '02': { 'Lv2':          ['二级包',     0b00000000000000000000000000001000] }
    }
  },
  'Head': {
    'F': {
      '01': { 'Lv2':          ['二级头',     0b00000000000000000000000000000100] },
      '02': { 'Lv2':          ['二级头',     0b00000000000000000000000000000100] }
    },
    'G': {
      '01': { 'Lv3':          ['三级头',     0b00000000000000000000000000000010] }
    }
  }
}
